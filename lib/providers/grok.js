...
function parseBillingPayload(payload) {
  ...
  // usage yet. A valid weekly period therefore means 0% used, not unknown.
  if (usedPct == null && (periodType.includes("weekly") || period.start || period.end)) {
    usedPct = 0;
...
module.exports = { id: ID, fetchUsage, parseBillingPayload, normalizeProducts };
