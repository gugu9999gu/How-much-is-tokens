...
async function fetchUsage() {
  ...
  // Banked resets are exposed by the official, read-only Codex app-server
  // account/rateLimits/read method. This widget never invokes the separate
  // account/rateLimitResetCredit/consume method, so merely viewing the widget
  // cannot spend a reset ticket.
  const rateLimitsRead = await readAccountRateLimits();
