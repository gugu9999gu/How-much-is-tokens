...
async function fetchUsage(_settings = {}, _secrets = {}, profile = null) {
  ...
  try {
    accountFacts = await readClaudeAccountFacts(oauth.accessToken, data, {
  ...
  return {
    ...
    brand: BRAND,
    status: "ok",
    plan: (accountFacts.billing && accountFacts.billing.planLabel) || oauth.subscriptionType || oauth.rateLimitTier,
