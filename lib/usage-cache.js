...
function sanitizeProvider(provider) {
  return {
    ...
    externalAccountRef: safeText(provider.externalAccountRef),
    managedBy: safeText(provider.managedBy),
    accountKey: safeText(provider.accountKey),
    accountLabel: safeText(provider.accountLabel),
    accountEmail: safeText(provider.accountEmail),
    accountLogin: safeText(provider.accountLogin),
    accountId: safeText(provider.accountId),
