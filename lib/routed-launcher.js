...
function installRouterLaunchers(options = {}) {
  ...
  try {
    ...
    // Windows PowerShell 5.1 does not reliably autodetect BOM-less UTF-8. The
    // generated script contains Korean status text, so write an explicit BOM
    // to keep both parsing and runtime output correct on supported Windows.
