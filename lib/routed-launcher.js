...
function installRouterLaunchers(options = {}) {
  ...
  try {
    ...
    fs.writeFileSync(readme, [
      ...
      "priority/max 정책은 오래된 cache를 사용하지 않으므로 위젯을 실행하거나 새로고침한 상태에서 사용하세요.",
