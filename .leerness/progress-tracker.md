...
| T-0005 | done | OpenRouter 추가 프로필/API Key를 직관적으로 추가·추적·정렬·삭제하는 설정 UX | PR #37 · PR CI 34454696918 success · main CI 34455308854 success · atomic safeStorage profile actions · renderer/secure-storage smoke | v1.0.32에 포함 배포 | 2026-09-10 |
| T-0006 | in-progress | 생성형 미디어 공급자 다계정 + 공식 MCP 잔여량 연동 | feat/v1.0.32-media-mcp-accounts · media profile safeStorage · official MCP endpoints · MCP-first/REST-fallback usage · account manager UI · package/lock 1.0.32 sync | Windows PR CI 및 실제 Electron smoke 검증 후 병합·배포 | 2026-09-10 |
