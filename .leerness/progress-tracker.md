...
| T-0004 | in-progress | v1.0.31 다계정/Smart Routing/프로필별 reset/CLI 유지보수 완성 | PR #35 · package/lock 1.0.31 sync · Cursor/Copilot/Antigravity account isolation · 6-provider routing · per-Codex-profile reset opt-in · docs/v1.0.31.md | 최신 PR Windows CI 전체 통과 후 병합·공개 배포 | 2026-09-10 |
