...
| T-0007 | in-progress | 토큰 카드 상단 고정핀 + 높이 자동조절 토글 + Antigravity compact 대표 quota 수정 | feat/v1.0.33-card-pins-autoheight · renderer pin/auto-height enhancement · default/AGM Gemini-summary regression tests · Electron smoke 추가 | PR Windows CI 전체 검증 | 2026-09-11 |
