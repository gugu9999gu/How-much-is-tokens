...
| T-0009 | incomplete | Grok을 몇 시간 사용하지 않아도 잔여량이 카드에서 사라지지 않게 하고 배포 | 로컬 `npm test` 통과. 원인: 만료된 access token을 로그아웃으로 처리해 hideMissing이 카드를 숨김. OIDC refresh와 login fallback 추가. 공개 릴리스는 진행 중 | 공개 v1.0.35 배포 확인 | 2026-09-23 |
