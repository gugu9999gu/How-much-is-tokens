...
| T-0007 | incomplete | Claude 5시간 한도, Claude/Codex 리셋 쿠폰 잔여, 설치 CLI 버전·업데이트 가능, 플랫폼별 결제·갱신일 표시 | plan:M-0004 · 로컬 `npm test` 통과(how-much-is-tokens@1.0.34) · `npm run leerness:gate` 통과 · `electron test/renderer-layout-smoke.js --disable-gpu` 통과. 공개 릴리스는 미게시 | 커밋 후 v1.0.34를 How-much-is-tokens-releases에 게시 | 2026-09-23 |
