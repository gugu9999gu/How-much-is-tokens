...
| T-0003 | in-progress | 설정을 미니멀 연결 허브로 재구성하고 플랫폼별 공식 로그인 자격증명 흐름 제공 | plan:M-0003 · validation 34076732991/34076905507 success · version sync 34077244587 success · v1.0.25 package/lock aligned | final validation 후 PR Windows CI | 2026-09-07 |
