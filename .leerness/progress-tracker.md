...
| T-0005 | in-progress | OpenRouter 추가 프로필/API Key를 직관적으로 추가·추적·정렬·삭제하는 설정 UX | feat/v1.0.32-openrouter-profile-ui · atomic safeStorage profile actions · quick profile cards · Electron/secure-storage smoke 추가 | Windows PR CI 전체 검증 | 2026-09-10 |
