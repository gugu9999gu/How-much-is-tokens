...
| T-0010 | incomplete | 스마트 라우팅과 Codex 리셋 쿠폰 자동 사용이 Windows에서 동작하는지 확인하고 배포 | npm test 통과. codex.cmd app-server early-exit를 네이티브 codex.exe로 수정. 이 PC read-only 조회는 reached 없음, 쿠폰 0장. Claude는 웹 전용, Grok은 사용 API 없음. 공개 릴리스 진행 중 | v1.0.36 배포 확인 | 2026-09-23 |
