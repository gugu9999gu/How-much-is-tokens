...
| T-0007 | done | Claude 5시간 한도, Claude/Codex 리셋 쿠폰 잔여, 설치 CLI 버전·업데이트 가능, 플랫폼별 결제·갱신일 표시 | plan:M-0004 · main 460e1b3 · public release run 35813268949 success · v1.0.34 SHA-256 4711a17aa0008efb3293862c113f9033d973df14547ba3362636c6b2496bac1f | 유지보수 | 2026-09-23 |
| T-0008 | done | 이 PC 자격증명으로 결제일 조회 가능 범위를 확인하고 카드 UI를 칸으로 정리 | 로컬 `npm test` 통과 · `electron test/renderer-layout-smoke.js --disable-gpu` 통과. Codex 구독 API 403, Claude는 구독 시작일만, agy는 한도 갱신 시각만 확인. v1.0.35에 포함 | 유지보수 | 2026-09-23 |
| T-0009 | done | Grok을 몇 시간 사용하지 않아도 잔여량이 카드에서 사라지지 않게 하고 배포 | main 7f13323 · public release run 35816119880 success · v1.0.35 SHA-256 9ed0cd19ff9784a3fd1aba4dfadb31bf45e35ff962eae91ecdc3a98dcd016f32 | 유지보수 | 2026-09-23 |
| T-0010 | done | 스마트 라우팅과 Codex 리셋 쿠폰 자동 사용이 Windows에서 동작하는지 확인하고 배포 | main 76dbd77 · public release run 35820007993 success · v1.0.36 SHA-256 3085e9df413617a941268bd27d45cb3424507e96b8cdcaed7c12adc477d5ef4a · 이 PC read-only 조회는 한도 미도달, 쿠폰 0장 | 유지보수 | 2026-09-23 |
